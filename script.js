...
//When either of the players' score reaches 20 call this function
function gameStop() {
    if (user.score == 20) {
        setTimeout (function () {
            alert("User Wins! Congratulations!");
            window.close();
        }, 50)
        window.close();
    } else if (ai.score == 20){
...
function render() {
  // set a style
  ctx.fillStyle = "#C7D1D0"; /* whatever comes below this acquires black color (#000). */
